...
{
    public class TimeTablesSerializer : BaseSerializer<TimeTableResponseModel>
    {
        ...
        //  --------------------------------------------------------------------------------
        /// <summary> TimeTablesSerializer class constructor. </summary>
        public TimeTablesSerializer() : base()
        {
            //
        }
        ...
        public override TimeTableResponseModel Deserialize(string rawData, params object[] parameters)
        {
            LoadParameters(parameters);

            var result = new TimeTableResponseModel()
            {
                Line = _line,
        ...
        private List<TimeTable> ReadTimeTables(XElement xmlData)
        {
            ...
            if (timeTablesDataNodes != null && timeTablesDataNodes.Any())
                ...
                {
                    TimeTable timeTable = ReadSpecialTimeTable(timeTableDataNode);
        ...
        private TimeTable ReadSpecialTimeTable(XElement timeTableDataNode)
        {
