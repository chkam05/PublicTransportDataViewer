...
namespace ZtmDataViewer.Utilities
{
    public static class ColorsHelper
    {
        ...
        //  --------------------------------------------------------------------------------
        /// <summary> Convert color to Hexadecimal color code method. </summary>
        ...
        //  --------------------------------------------------------------------------------
        /// <summary> Conver Hexadecimal color code to color method. </summary>
        ...
        //  --------------------------------------------------------------------------------
        /// <summary> Inverse color method. </summary>
        ...
        //  --------------------------------------------------------------------------------
        /// <summary> Update AHSL color method. </summary>
        ...
        //  --------------------------------------------------------------------------------
        /// <summary> Update RGB color method. </summary>
        ...
        //  --------------------------------------------------------------------------------
        /// <summary> Find color that contrasts with the input color method. </summary>
        /// <param name="color"> Color. </param>
