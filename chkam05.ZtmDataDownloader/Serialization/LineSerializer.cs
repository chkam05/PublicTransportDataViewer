...
{
    public class LineSerializer : BaseSerializer<LineResponseModel>
    {
        ...
        //  --------------------------------------------------------------------------------
        /// <summary> LineSerializer class constructor. </summary>
        public LineSerializer() : base()
        {
            //
        }
        ...
        public override LineResponseModel Deserialize(string rawData, params object[] parameters)
        {
            LoadParameters(parameters);

            var result = new LineResponseModel();
        ...
        private Line ReadData(XElement xmlData)
        {
        ...
        private void FillLineMetadata(XElement xmlData, Line line)
        {
        ...
        {
            var dateInformations = messageNode.Descendants("div")
                .Where(n =>
                    n.Attributes()
                        .Any(a => a.Name == "class" && a.Value == "text-right")
                    && n.Descendants("small").Any())
                .Select(n =>
                    n.Descendants("small")
